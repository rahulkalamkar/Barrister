...
@DatabaseTable(tableName = "SubCaseType")
public class SubCaseTypeTable implements Serializable {
    @DatabaseField(columnName = "id", generatedId = true)
    int id;

    @DatabaseField(columnName = "sub_case_type_id", unique = true, canBeNull = true)
    ...
    public SubCaseTypeTable(String case_type_id, String sub_case_type_id, String sub_case_type_name) {
        this.case_type_id = case_type_id;
        this.sub_case_type_id = sub_case_type_id;
        this.sub_case_type_name = sub_case_type_name;
    }

    public SubCaseTypeTable() {
    }
}
