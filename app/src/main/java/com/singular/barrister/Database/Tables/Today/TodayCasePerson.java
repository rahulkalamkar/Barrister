...
@DatabaseTable(tableName = "TodayCasePerson")
public class TodayCasePerson {
    ...
    public TodayCasePerson(String case_id, String opp_name, String mobile, String country_code, String type) {
        this.case_id = case_id;
        this.opp_name = opp_name;
        this.mobile = mobile;
        this.country_code = country_code;
