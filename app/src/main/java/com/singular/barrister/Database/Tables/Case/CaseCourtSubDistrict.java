...
@DatabaseTable(tableName = "CaseCourtSubDistrict")
public class CaseCourtSubDistrict {
    ...
    public CaseCourtSubDistrict() {
    }

    public CaseCourtSubDistrict(String id, String parent_id, String external_id, String name, String location_type, String pin) {
        this.subDistrictId = id;
        this.pin = pin;
        this.name = name;
        this.location_type = location_type;
