...
@DatabaseTable(tableName = "TodayCaseClientTable")
public class TodayCaseClientTable {
    ...
    public TodayCaseClientTable(String client_id, String first_name, String last_name, String country_code, String mobile, String email, String address) {
        this.client_id = client_id;
        this.first_name = first_name;
        this.last_name = last_name;
        this.country_code = country_code;
