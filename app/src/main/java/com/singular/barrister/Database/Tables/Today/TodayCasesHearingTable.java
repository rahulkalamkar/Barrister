...
@DatabaseTable(tableName = "TodayCasesHearingTable")
public class TodayCasesHearingTable {
    ...
    public TodayCasesHearingTable(String id, String case_id, String case_hearing_date, String case_decision, String case_disposed) {
        this.hearing_id = id;
        this.case_id = case_id;
        this.case_hearing_date = case_hearing_date;
        this.case_decision = case_decision;
