...
@DatabaseTable(tableName = "TodayCases_CaseType")
public class TodayCasesCaseType {
    ...
    public TodayCasesCaseType() {

    }

    public TodayCasesCaseType(String case_type_id, String case_type_name) {
        this.case_type_id = case_type_id;
        this.case_type_name = case_type_name;
    }
