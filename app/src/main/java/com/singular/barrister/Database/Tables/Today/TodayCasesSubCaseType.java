...
@DatabaseTable(tableName = "TodayCasesSubCaseType")
public class TodayCasesSubCaseType {
...
/*
   ...
   /* @DatabaseField(columnName = "case_type_id", canBeNull = true)
    ...
    public TodayCasesSubCaseType(String sub_case_type_id, String sub_case_type_name) {
        this.sub_case_type_id = sub_case_type_id;
        this.sub_case_type_name = sub_case_type_name;
    }

    public TodayCasesSubCaseType() {
    }
