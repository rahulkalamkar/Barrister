...
@DatabaseTable(tableName = "CaseCourtState")
public class CaseCourtState {
    ...
    public CaseCourtState() {
    }

    public CaseCourtState(String id, String parent_id, String external_id, String name, String location_type, String pin) {
        this.state_id = id;
        this.pin = pin;
        this.name = name;
