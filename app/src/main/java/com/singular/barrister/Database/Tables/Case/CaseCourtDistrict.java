...
@DatabaseTable(tableName = "CaseCourtDistrict")
public class CaseCourtDistrict {
    ...
    public CaseCourtDistrict(String id, String parent_id, String external_id, String name, String location_type, String pin) {
        this.district_id = id;
        this.pin = pin;
        this.name = name;
        this.location_type = location_type;
