package com.singular.barrister.Util.FCM.Service;
...
/**
 * Created by rahul.kalamkar on 12/14/2017.
 */

public class BarristerFirebaseMessagingService extends FirebaseMessagingService {
    String TAG = BarristerFirebaseMessagingService.class.getName();
